...
//Matínez Rejín,Moisés Alexander
//207435363
//Taller de sistemas operaivos avanzados sección D03
//Modificado para práctica 1
...
import sistemaDistribuido.sistema.clienteServidor.Alex.ProcesoCliente;
...
public class ClienteFrame extends ProcesoFrame{
	...
	public ClienteFrame(MicroNucleoFrame frameNucleo){
		super(frameNucleo,"Cliente de Archivos ALEX");
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				...
				imprimeln("Mensaje a enviar: "+campoMensaje.getText());
                                proc.Valores(codigosOperacion.getSelectedIndex(), campoMensaje.getText());
