 ...
 * codigo: 207465432
 * Modificaciones:
 *  agregar funcion get_data para obtencion de datos de interfaz
 */
public class ClienteFrame extends ProcesoFrame{
	...
	public Panel construirPanelSolicitud(){
		...
		pcodop1.add(new Label("Cuadrado >> "));
		pcodop1.add(new Label("Param 1:"));
		pcodop1.add(campo1);

		pcodop2.add(new Label("Factorial >> "));
		pcodop2.add(new Label("Param 1:"));
		pcodop2.add(campo2);

		pcodop3.add(new Label("Moda >> "));
	...
	class ManejadorSolicitud implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				...
				proc.get_data(campo1.getText(), campo2.getText(), campo3.getText(), campo4.getText());
