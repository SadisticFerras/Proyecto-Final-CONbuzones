 ...
 * Practica 4
 * Implementacion de llamadas a metodos de programa conector y su puenteo para actualizacion de programa conector y las interfaces
*
*/
public class RPC{
	...
	public static int importarInterfaz(String nombreServidor,String version){
            ...
            return Nucleo.registrarEnTablaEmision(asa);
	}
