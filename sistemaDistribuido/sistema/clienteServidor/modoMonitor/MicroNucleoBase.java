...
public abstract class MicroNucleoBase extends MicroKernelBase{
	...
	/**
	 * Pr�ctica 1 - Reanuda la ejecuci�n del proceso que le toque recibir mensaje
	 */
	protected void notificarHilos(){
		...
		for(i=0;i<j;i++){
			if ((p=dameProcesoLocal((int)procesos[i]))!=null){
				 ...
				 * pero s�lo hasta antes de llamar a dameProcesoLocal (en distribuido se provocar�a un paquete AU)
				 */
			}
		}
	...
	/**
	 * Desde Pr�ctica 2 - Inicia el sistema usando una fuente de informaci�n para IP e ID
	 */
	...
	/**
	 * Pr�ctica 2 - Para obtener de la interfaz gr�fica IP e ID del proceso destinatario
	 */
	...
	/**
	 * Pr�ctica 2 - devuelve distinto de null si el proceso des existe en esta m�quina 
	 */
	...
	/**
	 * Pr�ctica 2 - Devuelve true mientras el kernel no se le solicite cerrar desde la IG
	 */
